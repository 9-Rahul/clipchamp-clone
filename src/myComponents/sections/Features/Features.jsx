    ...
    return (
        <section className="features-outer">
            <div className="feature-one">
                ...
                <div className="features-vid-content-cover">
                    <div className="features-vid-content-container">
                        <div className="features-vid-content">
            ...
            <div className="features-section-outer">
                ...
                <div className="feature-section">
                    <div className="features-text">
                        ...
                        <div className="features-section-btn-container">
                    ...
                    <div className="features-img-container">
                        <Image className="features-img" src="/assets/images/voice-img.png"
                            alt="feature-img" height={280} width={500} loading="lazy" />
                    </div>
                </div>
                <div className="feature-section-two-cover">
                    <div className="feature-section two">
                        <div className="features-img-container">
                            <Image className="features-img" src="/assets/images/ai-sub.png"
                                alt="feature-img" height={280} width={500} loading="lazy" />
                        </div>
                ...
                <div className="feature-section">
                    ...
                    <div className="features-img-container">
                        <Image className="features-img" src="/assets/images/feature-three.png"
                            alt="feature-img" height={280} width={500} loading="lazy" />
                    </div>
                </div>
                ...
                <div className="feature-section-two-cover">
                    <div className="feature-section two">
                        <div className="features-img-container">
                            <Image className="features-img" src="/assets/images/ai-audio.png"
                                alt="feature-img" height={280} width={500} loading="lazy" />
                        </div>
                ...
                <div className="feature-section">
                    ...
                    <div className="features-img-container">
                        <a href="https://clipchamp.com/en/stock/">
                            <Image className="features-img" src="/assets/images/royalty.png"
                                alt="feature-img" height={280} width={500} loading="lazy" />
                        </a>
                    </div>
                </div>
                ...
                <div className="feature-section-two-cover">
                    ...
                    <div className="feature-section two">
                        <div className="features-img-container">
                            <Image className="features-img" src="/assets/images/safe-secure.png"
                                alt="feature-img" height={280} width={500} loading="lazy" />
                        </div>
            ...
            <div className="feature-section three">
                <div className="features-text three">
                ...
                <div className="features-cards-container">
                    ...
                    <div className="feature-card">
                        <div className="icon-and-card-title">
                        ...
                        <a href="#">Make a video now <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="arrow-icon"><path d="M5 12h14M12 5l7 7-7 7" /></svg></a>
                    </div>
                    ...
                    <div className="feature-card">
                        ...
                        <a href="#">Download for Windows <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="arrow-icon"><path d="M5 12h14M12 5l7 7-7 7" /></svg></a>
                    </div>
                    ...
                    <div className="feature-card">
                        ...
                        <a href="#">Download for iOS <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="arrow-icon"><path d="M5 12h14M12 5l7 7-7 7" /></svg></a>
                    </div>
                </div>
            </div>
